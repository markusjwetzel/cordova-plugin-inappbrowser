...
- (void)createViews
{
    ...
    NSString* backTitleString = NSLocalizedString(@"Zurück", nil); // create arrow from Unicode char
    self.closeButton = [[UIBarButtonItem alloc] initWithTitle:backTitleString style:UIBarButtonItemStylePlain target:self action:@selector(close)];
    self.closeButton.enabled = YES;
    self.closeButton.tintColor = [UIColor colorWithWhite:0.800 alpha:1.000];
    ...
    self.forwardButton.tintColor = [UIColor colorWithWhite:0.800 alpha:1.000];
    
    self.backButton = [[UIBarButtonItem alloc] initWithTitle:backTitleString style:UIBarButtonItemStylePlain target:self action:@selector(goBack:)];
    self.backButton.enabled = YES;
    self.backButton.imageInsets = UIEdgeInsetsZero;
    self.backButton.tintColor = [UIColor colorWithWhite:0.800 alpha:1.000];
